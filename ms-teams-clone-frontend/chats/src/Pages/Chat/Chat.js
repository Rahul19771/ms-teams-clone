...
import chat_48 from '../../images/chat_48.png';
import search_32 from '../../images/search_32.svg';
import calls_48 from '../../images/calls_48.png';
          ...
          viewListUser.push(
            ...
            <button
              ...
              onClick={() => {
                ...
                document.getElementById(item.key).style.backgroundColor = "#ededed"
            ...
            >
              ...
              <img
                ...
                alt=""
                placeholder={images.nopic}
              />

              <div className="viewWrapContentItem">
                <span className="textItem">{`${item.name
                  }`}</span>
              </div>
              {classname === 'viewWrapItemNotification' ?
    ...
    return (
      <div className="chat_root">
          ...
          <div className="viewListUser">
            ...
            <div className="rootsearchbar">
              <div className="input-container">
                <img className="icon" src={search_32} ></img>
        ...
        <div className="dashboard">
          ...
          />
          <p className="Chats_imgp"> Profile </p>
          </div>
          <div>
          <a className="Chats_img" href="#">
            <img src={chat_48} alt="" />
            <p className="Chats_imgp"> Chats </p>
          </a>
          </div>
          <div>
          <a className="Chats_img" href="https://ms-teams-clone-rahul.netlify.app/" target="_blank">
            <img src={calls_48} alt="" />
            <p className="Chats_imgp" > Calls </p>
          </a>
          </div>
