...
import { setLocalStream, setCallState, callStates, setCallingDialogVisible, setCallerUsername, setCallRejected, setRemoteStream, setScreenSharingOnline, resetCallDataState, setMessage } from '../../store/actions/callActions';
...
export const switchForScreenSharingStream = async () => {
  if (!store.getState().call.screenSharingOnline) {
    try {
      screenSharingStream = await navigator.mediaDevices.getDisplayMedia({ video: true });
      store.dispatch(setScreenSharingOnline(true));
    ...
    store.dispatch(setScreenSharingOnline(false));
