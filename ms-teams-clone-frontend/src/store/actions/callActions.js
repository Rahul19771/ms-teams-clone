...
export const CALL_SET_SCREEN_SHARING_ONLINE = 'CALL.SET_SCREEN_SHARING_ONLINE';
export const CALL_RESET_CALL_STATE = 'CALL.RESET_CALL_STATE';
export const CALL_SET_GROUP_CALL_ONLINE = 'CALL.CALL_SET_GROUP_CALL_ONLINE';
...
export const setScreenSharingOnline = (online) => {
  return {
    type: CALL_SET_SCREEN_SHARING_ONLINE,
    online
  };
}
;
...
export const setGroupCallOnline = (online) => {
  return {
    type: CALL_SET_GROUP_CALL_ONLINE,
    online
  };
};
