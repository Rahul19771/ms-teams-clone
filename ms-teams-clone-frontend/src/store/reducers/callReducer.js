...
const initState = {
  ...
  screenSharingOnline: false,
  groupCallOnline: false,
  groupCallStreams: [],
  message: {
    received: false,
    content: ''
...
const reducer = (state = initState, action) => {
  switch (action.type) {
    ...
    case callActions.CALL_SET_SCREEN_SHARING_ONLINE:
      return {
        ...state,
        screenSharingOnline: action.online
      };
    ...
    case callActions.CALL_SET_GROUP_CALL_ONLINE:
      return {
        ...state,
        groupCallOnline: action.online
      };
